...
QUERY_PREFERENCE_SYNONYMS = {
    "珍珠": ["珍珠", "珍奶", "珍珠奶茶", "波霸", "粉圓", "boba", "Boba", "tapioca", "pearl milk tea", "咀嚼感"],
    "波霸": ["波霸", "珍珠", "珍奶", "珍珠奶茶", "粉圓", "boba", "Boba", "tapioca", "pearl milk tea", "咀嚼感"],
    "粉圓": ["粉圓", "珍珠", "珍奶", "珍珠奶茶", "波霸", "boba", "Boba", "tapioca", "pearl milk tea", "咀嚼感"],
    "椰果": ["椰果", "咀嚼感"],
    "茶凍": ["茶凍", "凍", "咀嚼感"],
    "仙草": ["仙草", "仙草凍", "咀嚼感"],
    "布丁": ["布丁", "咀嚼感"],
    ...
    "奶茶": ["奶茶", "珍奶", "珍珠奶茶", "波霸奶茶", "鮮奶茶", "厚奶茶", "milk tea", "pearl milk tea"],
    # 注意：冬瓜茶不是水果茶。
...
NAME_TAG_RULES = [
    ...
    (["珍珠", "珍奶", "珍珠奶茶", "波霸", "波霸奶茶", "粉圓"], ["珍珠", "珍奶", "珍珠奶茶", "波霸", "粉圓", "咀嚼感", "奶茶", "奶類"]),
    (["椰果"], ["椰果", "咀嚼感"]),
    (["茶凍", "凍"], ["茶凍", "咀嚼感"]),
    (["仙草"], ["仙草", "仙草凍", "咀嚼感", "古早味"]),
    (["布丁"], ["布丁", "咀嚼感"]),
    (["奶蓋", "奶霜"], ["奶蓋", "奶霜", "奶類"]),
    (["奶茶", "珍奶", "珍珠奶茶", "波霸奶茶", "鮮奶", "拿鐵", "歐蕾", "可可", "巧克力"], ["奶茶", "奶類", "乳製品", "奶味"]),
    (["紅茶"], ["紅茶", "茶感", "純茶"]),
    (["綠茶"], ["綠茶", "茶感", "純茶"]),
    (["青茶"], ["青茶", "茶感", "純茶"]),
    (["烏龍", "鐵觀音"], ["烏龍茶", "茶感", "純茶"]),
